    ...
    class deleteActivityExecutor<A> implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                if (MemcachedClientWrapper.deleteValue(key) == Boolean.FALSE) {
                    throw new ElasticachePluginException(activityContext, RuntimeMessageBundle.FAILED_TO_DELETE_DATA.getErrorCode(),
                            RuntimeMessageBundle.FAILED_TO_DELETE_DATA.format(key));
                }
